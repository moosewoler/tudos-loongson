...
namespace KIP_namespace
{
  ...
  KIP mips_kernel_info_page asm("mips_kernel_info_page") __attribute__((section(".kernel_info_page"))) =
    {
      {
...
void Kip_init::init()
{
  Kip *kinfo = reinterpret_cast<Kip*>(&KIP_namespace::mips_kernel_info_page);
